...
public class WordCountReducerTest
{
  ...
  {
    new ReduceDriver<Text, IntWritable, Text, IntWritable>().withReducer(new WordCountReducer())
        .withInput(key, Arrays.asList(new IntWritable(1), new IntWritable(3))).withOutput(key, new IntWritable(4));
  }
}
